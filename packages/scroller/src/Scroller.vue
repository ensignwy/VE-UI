    ...
    <div class="_v-content" :id="contentId">
      ...
      >
        <span class="spinner-holder">
          ...
          <span class="text" v-if="state != 2" :style="{color: refreshAndLoadingTextColor}" v-text="refreshText"></span>
      ...
      <div v-if="showInfiniteLayer" class="loading-layer">
        ...
        <div class="no-data-text"
          :class="{'active': !showLoading && loadingState == 2}" :style="{color: refreshAndLoadingTextColor}"
          v-text="noDataText">
        </div>
      </div>
    </div>
